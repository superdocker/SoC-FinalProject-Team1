...
void write_rule(hls::stream<hls::vector<DTYPE,(KERNEL_SIZE*KERNEL_SIZE*2*NUM_FEATURE)>> &RuleStream,
                hls::stream<hls::vector<DTYPE,COL_SIZE>> &MergedCol_,
                hls::stream<hls::vector<DTYPE,COL_SIZE*3>> &KIPairs,
                hls::stream<DTYPE> &OutNumFeaturePerRow,
                hls::stream<DTYPE> &OutCsrCol) {
    ...
    hls::vector<DTYPE,(KERNEL_SIZE*KERNEL_SIZE*2*NUM_FEATURE)> Rule;
...
#pragma HLS DATAFLOW
    ...
    hls::stream<hls::vector<DTYPE,(KERNEL_SIZE*KERNEL_SIZE*2*NUM_FEATURE)>> RuleStream("RuleStream");
