...
int main(int argc, char** argv) {
    ...
    OCL_CHECK(err, err = q.enqueueMigrateMemObjects({buffer_y}, 0 /* 0 means from host*/));
    //OCL_CHECK(err, err = q.enqueueMigrateMemObjects({buffer_z}, 0 /* 0 means from host*/));
    q.finish();
